...
#     1) Training accuracy
#     2) Testing accuracy
# If the training accuracy is 100% but testing is lower, explain why this happens.
...
train_pred_none = model_depth_none.predict(X_train)
train_accuracy_none = accuracy_score(Y_train, train_pred_none)

# Testing predictions and accuracy
test_pred_none = model_depth_none.predict(X_test)
test_accuracy_none = accuracy_score(Y_test, test_pred_none)

print(f"Training Accuracy with max_depth=None: {train_accuracy_none*100:.2f}%")
print(f"Testing Accuracy with max_depth=None: {test_accuracy_none*100:.2f}%")