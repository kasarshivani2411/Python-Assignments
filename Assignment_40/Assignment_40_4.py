...
print(Border)
print("Predict Results for 5 New Students")
print(Border)

# new students DataFrame
new_students = pd.DataFrame({
    "StudyHours": [2.5, 6.0, 4.0, 8.0, 3.0],
    "Attendance": [68, 85, 75, 95, 70],
    "PreviousScore": [48, 70, 55, 82, 50],
    "SleepHours": [6, 7, 6, 8, 5],
    "AssignmentsCompleted": [3, 8, 5, 9, 4]
})
...
new_students["PredictedFinalResult"] = new_predictions

new_students["PredictedResultLabel"] = new_students["PredictedFinalResult"].map({
    0: "Fail",
    1: "Pass"
})
