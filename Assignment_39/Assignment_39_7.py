...
###########################################################################################
# Calculate Training and Testing Accuracy & Check Overfitting/Underfitting
###########################################################################################
...
print(Border)
print("Predict result for a new student")
print(Border)

# Define the new student's data in the correct order
...
]], columns=feature_cols)  # Ensure same order as training

# Predict using the trained model
prediction = model.predict(new_student)

print(f"Predicted Result for the student: {prediction[0]}")